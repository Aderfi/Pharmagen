...
dict_json = "ATC_farmaco_ENG_corregido.json"    # El archivo JSON con el diccionario key-value
...
with open(csv_input, 'r', encoding='utf-8') as infile, open(csv_output, 'w', newline='', encoding='utf-8') as outfile:
    ...
    for iter in range(len(data_df)):
        ...
        for dic in inversed_dictio:
            if drug_name in dic:
                ...
                data_df.at[iter, 'ATC'] = atc_code  # Asigna el código ATC a la nueva columna
                break        
