...
SAVE_MODEL_AS = "modelo_farmaco_effect_entity.pth"
...
class PharmacoModel(nn.Module):
    def __init__(self, n_drugs, n_genotypes, n_effects, n_entitys,
...
def objective(trial):
    ...
    model = PharmacoModel(n_drugs, n_genotypes, n_effects, n_entitys,
