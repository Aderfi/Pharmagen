...
GENE_RAW_DATA_DIR = RAW_DATA_DIR / "genotype_raw"       # Carpeta para datos genéticos sin procesar
DRUG_RAW_DATA_DIR = RAW_DATA_DIR / "drug_raw"          # Carpeta para datos de fármacos sin procesar
