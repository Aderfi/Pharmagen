...
class ConfiguradorEntorno:
    ...
    def __init__(self, dir_proyecto):
        ...
        self.conda_env_file = (
            self.dir_proyecto.parent / "Pharmagen_Env" / "conda_env_pharmagen.yml"
        )
    ...
    def instalar_dependencias_python_env(self, libs=None):
        ...
        if not self.python_executable.exists():
            print(
                f"ERROR: No se encontró el ejecutable de Python en {self.python_executable}"
            )
    ...
    def instalar_dependencias_conda_env(self):
        ...
        if not self.conda_env_file.exists():
            print(
                f"ERROR: No se encontró el archivo de entorno Conda en {self.conda_env_file}"
            )
            return
